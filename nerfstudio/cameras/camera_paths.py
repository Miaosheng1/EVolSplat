...
def get_interpolated_camera_path(cameras: Cameras, steps: int, order_poses: bool = False) -> Cameras:
    ...
    height,width = cameras.height[0], cameras.width[0]
    ## For Kitti, interpolate the left camera
    poses = cameras.camera_to_worlds[::2]
    # poses = cameras.camera_to_worlds[[0,-2],...]
