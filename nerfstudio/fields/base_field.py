...
class Field(nn.Module):
    ...
    def background_generate(self, ray_samples: RaySamples, sampled_rgb: Tensor) -> Dict[FieldHeadNames, Tensor]:
        """Evaluates the field at points along the ray.
        ...
        density, density_embedding = self.get_density(ray_samples,sampled_rgb=sampled_rgb) #type: ignore
