...
__C.ASSETS_PATH = '/home/smiao/nvi_sem/checkpoints'
...
__C.MODEL.HRNET_CHECKPOINT = \
    os.path.join('/home/smiao/Gen_Dataset/dataset_methods/nvi_sem/checkpoints', 'hrnetv2_w48_imagenet_pretrained.pth')
